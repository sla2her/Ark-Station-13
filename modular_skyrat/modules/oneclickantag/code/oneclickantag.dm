...
/datum/admins/
	...
	var/MAKEANTAG_PL_DEFAULT_SECURITY = list(JOB_PRISONER, JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_DETECTIVE, JOB_HEAD_OF_SECURITY, JOB_CAPTAIN, JOB_BLUESHIELD, JOB_BOUNCER, JOB_SECURITY_MEDIC, JOB_LAWYER)
