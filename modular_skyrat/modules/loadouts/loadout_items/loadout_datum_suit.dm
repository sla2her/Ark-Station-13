...
/datum/loadout_item/suit/navybluejacketofficer
	...
	restricted_roles = list(JOB_SECURITY_OFFICER, JOB_HEAD_OF_SECURITY, JOB_WARDEN, JOB_SECURITY_MEDIC) // I aint making a medic one, maybe i'll add some rank thing from cm or civ for it
...
/datum/loadout_item/suit/labcoat_highvis
	...
	restricted_roles = list(JOB_CHIEF_MEDICAL_OFFICER, JOB_PARAMEDIC, JOB_ATMOSPHERIC_TECHNICIAN, JOB_DETECTIVE, JOB_CHEMIST, JOB_SECURITY_MEDIC) // And now chemist and orderly get it too.
