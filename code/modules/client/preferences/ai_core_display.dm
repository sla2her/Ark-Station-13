...
/datum/preference/choiced/ai_core_display/icon_for(value)
	if (value == "Random")
		return icon('modular_arkstation/modules/new-ai-sprites/ai.dmi', "questionmark")
	else
		return icon('modular_arkstation/modules/new-ai-sprites/ai.dmi', resolve_ai_icon_sync(value))
