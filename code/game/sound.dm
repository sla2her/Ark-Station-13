...
/proc/get_sfx(soundin)
	if(istext(soundin))
		...
		switch(soundin)
			...
			if(SFX_BODYFALL)
				soundin = pick('modular_arkstation/modules/new-sounds/sound/bodyfall/bodyfall1.ogg','modular_arkstation/modules/new-sounds/sound/bodyfall/bodyfall2.ogg','modular_arkstation/modules/new-sounds/sound/bodyfall/bodyfall3.ogg','modular_arkstation/modules/new-sounds/sound/bodyfall/bodyfall4.ogg') // ARK STATION EDIT || NEW SOUNDS
			if(SFX_PUNCH)
