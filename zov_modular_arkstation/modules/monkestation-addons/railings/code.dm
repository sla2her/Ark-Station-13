/obj/structure/railing
	icon = 'zov_modular_arkstation/modules/monkestation-addons/railings/railing_basic.dmi'
...
/obj/structure/railing/wrestling
	name = "boxing ring"
	icon = 'zov_modular_arkstation/modules/monkestation-addons/railings/railing_wrestling.dmi'
	icon_state = "railing"
	material_flags = null
