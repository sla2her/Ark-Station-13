/obj/item/storage/backpack/satchel/lfwb
	...
	icon_state = "satchel"
	worn_icon = 'modular_arkstation/krashly_modulars/icons/mob/clothing/backpack.dmi'

/obj/item/storage/belt/medical/aesculapus
	name = "aesculapus medical belt"
	desc = "Can hold various medical equipment."
	icon = 'modular_arkstation/krashly_modulars/icons/obj/clothing/belt.dmi'
	worn_icon = 'modular_arkstation/krashly_modulars/icons/mob/clothing/belt.dmi'
...
/obj/item/storage/backpack/security/inteq
	...
	icon = 'modular_arkstation/krashly_modulars/icons/obj/clothing/backpack.dmi'
	worn_icon = 'modular_arkstation/krashly_modulars/icons/mob/clothing/backpack.dmi'
