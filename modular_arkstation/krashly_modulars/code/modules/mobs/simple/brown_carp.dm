/mob/living/basic/carp/brown
	...
	icon = 'modular_arkstation/krashly_modulars/icons/mob/simple_mob/brown_carp.dmi'
...
/mob/living/basic/carp/brown/beret
	...
	icon = 'modular_arkstation/krashly_modulars/icons/mob/simple_mob/brown_carp_beret.dmi'
