...
/obj/item/clothing/underwear
	...
	icon = 'modular_arkstation/modules/new-slots/underwear.dmi' //if someone is willing to make proper inventory sprites that'd be very cash money
	worn_icon = 'modular_arkstation/modules/new-slots/underwear.dmi'
	worn_icon_digi = 'modular_arkstation/modules/new-slots/underwear_digi.dmi'
...
GLOBAL_LIST_INIT(modular_ui_styles, list(
	'icons/hud/screen_midnight.dmi' = 'modular_arkstation/modules/new-slots/hud/screen_midnight.dmi',
	'icons/hud/screen_retro.dmi' = 'modular_arkstation/modules/new-slots/hud/screen_retro.dmi',
	'icons/hud/screen_plasmafire.dmi' = 'modular_arkstation/modules/new-slots/hud/screen_plasmafire.dmi',
	'icons/hud/screen_slimecore.dmi' = 'modular_arkstation/modules/new-slots/hud/screen_slimecore.dmi',
	'icons/hud/screen_operative.dmi' = 'modular_arkstation/modules/new-slots/hud/screen_operative.dmi',
	'icons/hud/screen_clockwork.dmi' = 'modular_arkstation/modules/new-slots/hud/screen_clockwork.dmi',
))
