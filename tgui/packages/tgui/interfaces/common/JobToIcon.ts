...
const ALTTITLES = {
  ...
  'Bar Owner': BASEICONS['Bartender'],
  'Sommelier': BASEICONS['Bartender'],
  'Barmaid': BASEICONS['Bartender'],
  // Blueshield - shield-dog
  'Command Bodyguard': BASEICONS['Blueshield'],
  'Executive Protection Agent': BASEICONS['Blueshield'],
  'Command Security': BASEICONS['Blueshield'],
  'Blueguard': BASEICONS['Blueshield'],
  'Command Guard': BASEICONS['Blueshield'],
  // Botanist - seedling
  ...
  'Bodyguard': BASEICONS['Bouncer'],
  'Hired Muscle': BASEICONS['Bouncer'],
  'Barmaid Sentinel': BASEICONS['Bouncer'],
  // Captain - crown
  'Station Commander': BASEICONS['Captain'],
  'Commanding Officer': BASEICONS['Captain'],
  'Site Manager': BASEICONS['Captain'],
  'Colony Overseer': BASEICONS['Captain'],
  'Senator': BASEICONS['Captain'],
  'Consul': BASEICONS['Captain'],
  'Sectorial Commander': BASEICONS['Captain'],
  // Cargo Technician - box
  ...
  'Shaman': BASEICONS['Chaplain'],
  'Pope': BASEICONS['Chaplain'],
  'Voodo Sorcerer': BASEICONS['Chaplain'],
  'Ritualist': BASEICONS['Chaplain'],
  'Bishop': BASEICONS['Chaplain'],
  'Pontiff': BASEICONS['Chaplain'],
  // Chemist - prescription-bottle
  'Pharmacist': BASEICONS['Chemist'],
  'Pharmacologist': BASEICONS['Chemist'],
  'Trainee Pharmacist': BASEICONS['Chemist'],
  'Alchemist': BASEICONS['Chemist'],
  // Chief Engineer - user-astronaut
  'Engineering Foreman': BASEICONS['Chief Engineer'],
  'Head of Engineering': BASEICONS['Chief Engineer'],
  'Senior Engineer': BASEICONS['Chief Engineer'],
  'Brigadier': BASEICONS['Chief Engineer'],
  'Head Engineer': BASEICONS['Chief Engineer'],
  'Construction Coordinator': BASEICONS['Chief Engineer'],
  'Project Manager': BASEICONS['Chief Engineer'],
  'Power Plant Director': BASEICONS['Chief Engineer'],
  // Chief Medical Officer - user-md
  ...
  'Nutritionis Specialist': BASEICONS['Cook'],
  // Coroner - skull
  'Mortician': BASEICONS['Coroner'],
  'Funeral Director': BASEICONS['Coroner'],
  'Necromancer': BASEICONS['Coroner'],
  // Curator - book
  'Librarian': BASEICONS['Curator'],
  'Journalist': BASEICONS['Curator'],
  'Archivist': BASEICONS['Curator'],
  'Reporter': BASEICONS['Curator'],
  'Correspondent': BASEICONS['Curator'],
  'Newsman': BASEICONS['Curator'],
  'Questioner': BASEICONS['Curator'],
  'Occultism Fan': BASEICONS['Curator'],
  // Cyborg - robot
  ...
  'Genetic Therapist': BASEICONS['Geneticist'],
  'Bioengineer': BASEICONS['Geneticist'],
  // Head of Personnel - dog
  ...
  'Crew Resource Officer': BASEICONS['Head of Personnel'],
  'Headpat Of Personnel': BASEICONS['Head of Personnel'],
  'Headgiver To Personnel': BASEICONS['Head of Personnel'],
  'Personnel Manager': BASEICONS['Head of Personnel'],
  'Staff Administrator': BASEICONS['Head of Personnel'],
  'Records Administrator': BASEICONS['Head of Personnel'],
  // Head of Security - user-shield
  ...
  'Division Leader': BASEICONS['Head of Security'],
  'Comissar': BASEICONS['Head of Security'],
  // Janitor - soap
  ...
  'Medical Secretary': BASEICONS['Medical Doctor'],
  // Mime - comment-slash
  'Pantomimist': BASEICONS['Mime'],
  'Performer': BASEICONS['Mime'],
  // Nanotrasen Consultant - clipboard-check
  'Nanotrasen Diplomat': BASEICONS['Nanotrasen Consultant'],
  'Judge': BASEICONS['Nanotrasen Consultant'],
  'Magistrate': BASEICONS['Nanotrasen Consultant'],
  'Advisor': BASEICONS['Nanotrasen Consultant'],
  // Paramedic - truck-medical
  ...
  'Hypnotist': BASEICONS['Psychologist'],
  'Hypnosis Expert': BASEICONS['Psychologist'],
  'Hypnotherapist': BASEICONS['Psychologist'],
  // Quartermaster - sack-dollar
  ...
  'Science Administrator': BASEICONS['Research Director'],
  'Research Manager': BASEICONS['Research Director'],
  // Roboticist - battery-half
  ...
  'Robotics Operator': BASEICONS['Roboticist'],
  'MODsuit Engineer': BASEICONS['Roboticist'],
  // Scientist - flask
  ...
  'Brig Doctor': BASEICONS['Security Medic'],
  'Security EMT': BASEICONS['Security Medic'],
  'Brig EMT': BASEICONS['Security Medic'],
  // Security Officer - shield-halved
  ...
  'Security Trainee': BASEICONS['Security Officer'],
  'Security Agent': BASEICONS['Security Officer'],
  'SAARE Operative': BASEICONS['Security Officer'],
  'PCRC Operative': BASEICONS['Security Officer'],
  'Nanotrasen Combatant': BASEICONS['Security Officer'],
  'Enforcer': BASEICONS['Security Officer'],
  // Shaft Miner - digging
  ...
  'Digger': BASEICONS['Shaft Miner'],
  'Hunter': BASEICONS['Shaft Miner'],
  'Ash Walker Breeder': BASEICONS['Shaft Miner'],
  // Station Engineer - gears
  ...
  'Microbiologist': BASEICONS['Virologist'],
  'Biochemist': BASEICONS['Virologist'],
  'Bioweapon Scientist': BASEICONS['Virologist'],
  'Plague Doctor': BASEICONS['Virologist'],
  'Monkey Destroyer': BASEICONS['Virologist'],
  // Warden - handcuffs
  'Brig Sergeant': BASEICONS['Warden'],
  'Dispatch Officer': BASEICONS['Warden'],
  'Brig Governor': BASEICONS['Warden'],
  'Jailer': BASEICONS['Warden'],
  'Prison Guard': BASEICONS['Warden'],
  'Armory Manager': BASEICONS['Warden'],
  'Prison Administrator': BASEICONS['Warden'],
  'Security Captain': BASEICONS['Warden'],
  'Brig Superintendent': BASEICONS['Warden'],
  'Brig Overwatch': BASEICONS['Warden'],
  'High-Ranked Security Officer': BASEICONS['Warden'],
  // Bridge Officer
